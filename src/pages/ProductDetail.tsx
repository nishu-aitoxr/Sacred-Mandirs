...
interface Product {
  ...
  material?: string;
  craftTime?: string;
  type: 'sitting' | 'standing'; // Add type property
}
...
const ProductDetail = () => {
  ...
  // All products data with type categorization
  const allProducts: Product[] = [
    // Sitting Mandirs (IDs 1-10)
    {
      id: 1,
  ...
  const relatedProducts = allProducts
    ...
    .slice(0, 10); // Show up to 6 related products
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        {/* Related Products Section - Now filtered by type */}
        {relatedProducts.length > 0 && (
          <div className="mt-20">
            <h2 className="text-3xl font-playfair font-bold text-center mb-12 text-gradient">
              Similar {product.type === 'sitting' ? 'Sitting' : 'Standing'} Mandirs
            </h2>
